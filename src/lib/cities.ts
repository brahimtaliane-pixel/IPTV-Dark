...
export const CITIES_DATA: Record<string, CityData> = {
  geneve: {
    ...
    meta_nl: {
      title: 'IPTV Genève | IPTV Nederland — 30.000+ zenders HD/4K 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Genf - Bestes IPTV-Abo in Genf 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Genf. +30\'000 HD/4K-Kanäle, Filme und Serien. Aktivierung in 2h, 24/7 Support. Bestes IPTV-Abo Genf ab 35.99 €. Kompatibel mit Swisscom, Sunrise, Salt.',
  ...
  zurich: {
    ...
    meta_nl: {
      title: 'IPTV Zürich | IPTV Nederland — beste IPTV Zürich 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Zürich - Bestes IPTV-Abo in Zürich 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Zürich. +30\'000 HD/4K-Kanäle, Filme und Serien. Aktivierung in 2h, 24/7 Support. Bestes IPTV-Abo Zürich ab 35.99 €. Kompatibel mit Swisscom, Sunrise, UPC.',
  ...
  lausanne: {
    ...
    meta_nl: {
      title: 'IPTV Lausanne | IPTV Nederland — Vaud & Lausanne 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Lausanne - Bestes IPTV-Abo in Lausanne 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Lausanne. +30\'000 HD/4K-Kanäle, Filme und Serien. Aktivierung in 2h, 24/7 Support. Bestes IPTV-Abo Lausanne ab 35.99 €. Kompatibel mit allen ISPs.',
  ...
  bern: {
    ...
    meta_nl: {
      title: 'IPTV Bern | IPTV Nederland — IPTV in de bondsstad 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Bern - Bestes IPTV-Abo in Bern 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Bern. +30\'000 HD/4K-Kanäle, Filme und Serien. Aktivierung in 2h, 24/7 Support. Bestes IPTV-Abo Bern ab 35.99 €. Kompatibel mit Swisscom, Sunrise.',
  ...
  basel: {
    ...
    meta_nl: {
      title: 'IPTV Basel | IPTV Nederland — drielandenregio 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Basel - Bestes IPTV-Abo in Basel 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Basel. +30\'000 HD/4K-Kanäle, Filme und Serien. Aktivierung in 2h, 24/7 Support. Bestes IPTV-Abo Basel ab 35.99 €. Kompatibel mit allen ISPs.',
  ...
  winterthur: {
    ...
    meta_nl: {
      title: 'IPTV Winterthur | IPTV Nederland — kanton Zürich 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Winterthur - IPTV-Abo in Winterthur 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Winterthur. +30\'000 HD/4K-Kanäle. Aktivierung in 2h, 24/7 Support. IPTV-Abo Winterthur ab 35.99 €.',
  ...
  'st-gallen': {
    ...
    meta_nl: {
      title: 'IPTV St. Gallen | IPTV Nederland — Oost-Zwitserland 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV St. Gallen - IPTV-Abo in St. Gallen 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in St. Gallen. +30\'000 HD/4K-Kanäle. Aktivierung in 2h, 24/7 Support. IPTV-Abo St. Gallen ab 35.99 €.',
  ...
  lugano: {
    ...
    meta_nl: {
      title: 'IPTV Lugano | IPTV Nederland — Ticino & Italië 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Lugano - IPTV-Abo in Lugano 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Lugano. +30\'000 HD/4K-Kanäle, italienische Kanäle inklusive. Aktivierung in 2h. IPTV-Abo Lugano ab 35.99 €.',
  ...
  biel: {
    ...
    meta_nl: {
      title: 'IPTV Biel/Bienne | IPTV Nederland — tweetalig FR/DE 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Biel - IPTV-Abo in Biel 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Biel. +30\'000 HD/4K-Kanäle, zweisprachiger Support FR/DE. Aktivierung in 2h. IPTV-Abo Biel ab 35.99 €.',
  ...
  luzern: {
    ...
    meta_nl: {
      title: 'IPTV Luzern | IPTV Nederland — Centraal-Zwitserland 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Luzern - IPTV-Abo in Luzern 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Luzern. +30\'000 HD/4K-Kanäle. Aktivierung in 2h, 24/7 Support. IPTV-Abo Luzern ab 35.99 €.',
  ...
  fribourg: {
    ...
    meta_nl: {
      title: 'IPTV Fribourg | IPTV Nederland — tweetalig FR/DE 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Freiburg - IPTV-Abo in Freiburg 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Freiburg. +30\'000 HD/4K-Kanäle, zweisprachiger Support. Aktivierung in 2h. IPTV-Abo Freiburg ab 35.99 €.',
  ...
  neuchatel: {
    ...
    meta_nl: {
      title: 'IPTV Neuchâtel | IPTV Nederland — kanton Neuchâtel 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Neuenburg - IPTV-Abo in Neuenburg 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Neuenburg. +30\'000 HD/4K-Kanäle. Aktivierung in 2h, 24/7 Support. IPTV-Abo Neuenburg ab 35.99 €.',
  ...
  thun: {
    ...
    meta_nl: {
      title: 'IPTV Thun | IPTV Nederland — Berner Oberland 2026 | Vanaf 35,99 €',
      description:
    ...
    meta_de: {
      title: 'IPTV Thun - IPTV-Abo in Thun 2026 | Ab 35.99 €',
      description: 'Premium IPTV-Service in Thun. +30\'000 HD/4K-Kanäle. Aktivierung in 2h, 24/7 Support. IPTV-Abo Thun ab 35.99 €.',
